...
import 'package:workapp/screens/mode.dart';
    ...
    return Scaffold(
      body: Container(
        ...
        decoration: BoxDecoration(
          ...
          // Uncomment the following line if you want to add a background color as well
          // color: Colors.black.withOpacity(0.5), // Example for semi-transparent black background
        ),
        child: Padding(
